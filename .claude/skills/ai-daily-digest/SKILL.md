...
- **🔥 오늘의 핵심**: 2~3건. "오늘 안 읽으면 놓친다" 수준의 임팩트. 신규 모델 릴리즈, 메이저 제품 발표, 파급력 큰 논문·툴 등.
- **📘 주목할 만한 소식**: 4~6건. 한 줄 요약. 업계 동향, 툴 릴리즈, 의미 있는 벤치마크, trending 레포 등.

심화/논문 전용 섹션은 두지 않습니다. 개발자 독자에게 논문 abstract 는 진입장벽이 높고, 정말 임팩트 있는 논문은 자연스럽게 🔥 또는 📘 에 편입됩니다.
